...
```bash
git remote add encore encore://omg-post-studio-ik6i
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/omg-post-studio-ik6i/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/omg-post-studio-ik6i/settings/integrations/github)
